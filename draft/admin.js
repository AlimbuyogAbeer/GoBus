...
function loadState() {
  try {
    ...
    return { config: { times: ['08:00','12:00','16:00'], activeDays: ['mon','tue','wed','thu','fri','sat','sun'] }, schedules: {}, scheduleGroups: [], reservations: [], defaults: { deluxe:20, regular:40 }, terminals:['Manila','Cebu','Davao'] };
  }
}
...
function handleLoginForm(e){
  ...
  if (email.toLowerCase() === ADMIN_USER && pass === ADMIN_PASS){
    setAdminSession();
    location.href = 'admin-schedules.html';
  } else {
...
window.logoutAdmin = function(){ clearAdminSession(); location.href='admin-login.html'; };
